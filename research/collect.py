...
from model_io import capture, expand, load, margin, patch_scores, setup, targets
...
def main():
    ...
    with torch.inference_mode():
        ...
        corrupt = [{**r, "a": r["c"]} for r in train]
        ...
        valbad = [{**r, "a": r["c"]} for r in validation]
