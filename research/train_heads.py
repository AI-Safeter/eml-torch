...
def main():
    ...
    kinds = ["eml_square", "silu", "eml_affine", "eml_log", "silu_two"]
    grid = [
        (kind, width, seed, weight)
        for seed in [17, 29, 43]
        for width in args.widths
        for weight in [4.0, 0.0]
        for kind in kinds
    ]
    ...
    protocol = {
        ...
        "weight_zero_is_ablation": True,
        "seed_order": [17, 29, 43],
        "families": "Learned affine arguments, squared log arguments, log-only EML, SiLU controls; no discrete symbolic-discovery claim.",
